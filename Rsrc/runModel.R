...
for(i in 1:5){
  for(siteX in 1:7){
    ...
    p_Litter$nGV$spruce[[paste0("st",i)]][[paste0("site",siteX)]] <- nwLitPlot(prebRuns$spruce[[i]],siteX)
    p_Litter$nGV$pine[[paste0("st",i)]][[paste0("site",siteX)]] <- nwLitPlot(prebRuns$pine[[i]],siteX)
    p_Litter$nGV$all[[paste0("st",i)]][[paste0("site",siteX)]] <- nwLitPlot(prebRuns$all[[i]],siteX)
